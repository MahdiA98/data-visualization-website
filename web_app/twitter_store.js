            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    twitterResult.statuses.forEach(function (tweet) {
                        ...
                        promiseArray_1.push((0, database_function_1.saveTwitterData)(tweet.id, tweet.text, unixTimestamp, keyword));
                    });
...
function convertDateHelper(month) {
...
storeTweets("Manchester City");
//# sourceMappingURL=twitter_store.js.map