/*
TO DO:
- Fix bug related to multiple charts appearing
- Fix bug related to sizing of website, make more responsive to larger screen resolutions
- Modularise and condense .onmessage function (currently unreadable and messy)
*/
